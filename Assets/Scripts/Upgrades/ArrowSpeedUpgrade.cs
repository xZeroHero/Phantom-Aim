...
public class ArrowSpeedUpgrade : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        m_UpgradeManager.ArrowSpeedUpgradeLimit = m_SpiritCostList.Length;
        UpdateButton();
    ...
    public void UpgradeArrowSpeed()
    {
        ...
        {
            //Update Stats
            //m_GameManager.ArrowSpeed += m_UpgradeManager.ArrowSpeedModifier;

            //RemoveSpirit
            m_GameManager.Spirit -= m_SpiritCostList[m_TimesUpgraded];

            //Update Upgrades Bought
            m_UpgradeManager.ArrowSpeedUpgrades++;
    ...
    public void UpdateButton()
    {
        ...
        m_BuyLimit = m_UpgradeManager.ArrowSpeedUpgradeLimit;
        m_TimesUpgraded = m_UpgradeManager.ArrowSpeedUpgrades;
