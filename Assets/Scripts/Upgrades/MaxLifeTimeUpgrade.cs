...
public class MaxLifeTimeUpgrades : MonoBehaviour
{

    //public Button m_Button;
    public UpgradeManager m_UpgradeManager;
    public GameManager m_GameManager;
    public TextMeshProUGUI SpiritCostMaxLife;
    public TextMeshProUGUI TimesBoughtMaxLife;
    ...
    public void Start()
    {
        ...
        m_UpgradeManager.MaxLifeTimeUpgradeLimit = m_SpiritCostList.Length;
        UpdateButton();
    ...
    public void SetSpiritCost()
    {
        ...
        {
            SpiritCostMaxLife.text = m_SpiritCostList[m_TimesUpgraded].ToString();
        }
        else
        {
            SpiritCostMaxLife.text = "---";
        }
    ...
    {
        TimesBoughtMaxLife.text = m_TimesUpgraded.ToString() + "/" + m_BuyLimit.ToString();
    }

    public void UpgradeMaxLifeTime()
    {
        ...
        {
            //Update Stats
            //m_GameManager.MaxLifeTime += m_UpgradeManager.MaxLifeTimeModifier;

            //RemoveSpirit
            m_GameManager.Spirit -= m_SpiritCostList[m_TimesUpgraded];

            //Update Upgrades Bought
            m_UpgradeManager.MaxLifeTimeUpgrades++;
    ...
    public void UpdateButton()
    {
        ...
        m_BuyLimit = m_UpgradeManager.MaxLifeTimeUpgradeLimit;
        m_TimesUpgraded = m_UpgradeManager.MaxLifeTimeUpgrades;
