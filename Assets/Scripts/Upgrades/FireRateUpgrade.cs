...
public class FireRateUpgrade : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        m_UpgradeManager.FireRateUpgradeLimit = m_SpiritCostList.Length;   
        UpdateButton();
    ...
    public void UpgradeFireRate()
    {
        ...
        {
            //Update Stats
            //m_GameManager.FireRate -= m_UpgradeManager.FireRateModifier;        

            //RemoveSpirit
            m_GameManager.Spirit -= m_SpiritCostList[m_TimesUpgraded];

            //Update Upgrades Bought
            m_UpgradeManager.FireRateUpgrades++;
    ...
    public void UpdateButton()
    {
        ...
        m_BuyLimit = m_UpgradeManager.FireRateUpgradeLimit;                       
        m_TimesUpgraded = m_UpgradeManager.FireRateUpgrades;                      
