...
public class MaxHealthUpgrade : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        m_UpgradeManager.MaxHealthUpgradeLimit = m_SpiritCostList.Length;   
        UpdateButton();
    ...
    public void UpgradeMaxHealth()
    {
        ...
        {
            //Update Stats
            //m_GameManager.MaxHealth += m_UpgradeManager.MaxHealthModifier;        

            //RemoveSpirit
            m_GameManager.Spirit -= m_SpiritCostList[m_TimesUpgraded];

            //Update Upgrades Bought
            m_UpgradeManager.MaxHealthUpgrades++; 
    ...
    public void UpdateButton()
    {
        ...
        m_BuyLimit = m_UpgradeManager.MaxHealthUpgradeLimit;                       
        m_TimesUpgraded = m_UpgradeManager.MaxHealthUpgrades;                      
