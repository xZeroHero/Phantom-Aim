...
public class RotationSpeedUpgrade : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        m_UpgradeManager.RotationSpeedUpgradeLimit = m_SpiritCostList.Length;  
        UpdateButton();
    ...
    public void UpgradeRotationSpeed()
    {
        ...
        {
            //Update Stats
            //m_GameManager.RotationSpeed += m_UpgradeManager.RotationSpeedModifier;        

            //RemoveSpirit
            m_GameManager.Spirit -= m_SpiritCostList[m_TimesUpgraded];

            //Update Upgrades Bought
            m_UpgradeManager.RotationSpeedUpgrades++;      
    ...
    public void UpdateButton()
    {
        ...
        m_BuyLimit = m_UpgradeManager.RotationSpeedUpgradeLimit;                       
        m_TimesUpgraded = m_UpgradeManager.RotationSpeedUpgrades;                      
