...
public class SpiritUpgrade : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        m_UpgradeManager.SpiritUpgradeLimit = m_SpiritCostList.Length;  
        UpdateButton();
    ...
    public void UpgradeSpirit()
    {
        ...
        if (m_TimesUpgraded <  m_BuyLimit && m_SpiritCostList[m_TimesUpgraded] <= m_CurrentSpirit)
        {
            ...
            m_UpgradeManager.SpiritUpgrades++;      
    ...
    public void UpdateButton()
    {
        ...
        m_BuyLimit = m_UpgradeManager.SpiritUpgradeLimit;                       
        m_TimesUpgraded = m_UpgradeManager.SpiritUpgrades;                      


        SetSpiritCost();
        SetTimesBought();
        InstantiateSkillCheckmarks();
        Debug.Log("Updated Button");
