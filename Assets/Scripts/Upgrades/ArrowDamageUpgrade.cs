...
public class ArrowDamageUpgrade : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        m_UpgradeManager.ArrowDamageUpgradeLimit = m_SpiritCostList.Length;   
        UpdateButton();
    ...
    public void UpgradeArrowDamage()
    {
        ...
        {
            //Update Stats
            //m_GameManager.ArrowDamage += m_UpgradeManager.ArrowDamageModifier;        

            //RemoveSpirit
            m_GameManager.Spirit -= m_SpiritCostList[m_TimesUpgraded];

            //Update Upgrades Bought
            m_UpgradeManager.ArrowDamageUpgrades++;
    ...
    public void UpdateButton()
    {
        ...
        m_BuyLimit = m_UpgradeManager.ArrowDamageUpgradeLimit;                       
        m_TimesUpgraded = m_UpgradeManager.ArrowDamageUpgrades;                      
